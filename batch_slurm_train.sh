...
python train_dreambooth_lora_sdxl_rl.py --cp_dataset data/cp_chikawa_new_2 --checkpoint_path /net/projects2/litian-lab/dixi/checkpoints_tlora_overfit/checkpoint-iter001-lora1-step5000/ --output_dir /net/projects2/litian-lab/dixi/checkpoints_tlora_rl --resume_wr_checkpoint  /net/projects2/litian-lab/dixi/checkpoints_tlora_rl/wr_checkpoint_step002500.pt